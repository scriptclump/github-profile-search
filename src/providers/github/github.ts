...
export class GithubProvider {
  ...
  */
  ...
  /* 
    Returns user Follower information for the username parameter
  */
  getFollowerInformation(username: string): Observable<Follower[]> {
    return this.http.get(`${this.baseUrl}/${username}/followers`).map((data: Response) => data.json() as Follower[]);
  }

  /* 
    Returns user Following information for the username parameter
  */
  getFollowingInformation(username: string): Observable<Following[]> {
    return this.http.get(`${this.baseUrl}/${username}/following`).map((data: Response) => data.json() as Following[]);
  }
